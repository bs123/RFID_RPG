...
public class MqttNRedClient implements MqttCallback  {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            MqttNRedClient sampleClient = new MqttNRedClient(url, clientId, cleanSession, quietMode,userName,password);
     ...
     */
    public MqttNRedClient(String brokerUrl, String clientId, boolean cleanSession, boolean quietMode, String userName, String password) throws MqttException {
